					...
					<form action="change_s_pwd.php" method="POST" id="bb">	
						...
						<div class="form-group">					
							<div class="input-group">
								<div class="input-group-addon">
									...
									<input type="text" class="form-control" name="login_id" placeholder="ID đăng nhập của bạn" data-rule-required="true" data-rule-minlength="6"/>
							</div>
						</div>				
						...
						<div class="form-group">					
							<div class="input-group">
								...
								<input type="text" name="login_key"  class="form-control" placeholder="Khóa bí mật của bạn" data-rule-required="true" data-rule-minlength="6">
							</div>				
						</div>
						...
						<div class="form-group">
							...
							<a href="./index.php"><button  type="button" class="btn btn-primary">Hủy bỏ</button></a>
						</div>
					</form>
