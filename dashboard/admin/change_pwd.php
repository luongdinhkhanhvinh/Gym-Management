...
<head>
    ...
    <title>Titan Gym | Khởi động</title>
       ...
       <form id="form1" name="form1" action="change_s_pwd.php" enctype="multipart/form-data" method="POST" class="a1-container" >
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
			   ...
			   <tr>
               <td height="35">CHÌA KHÓA ĐĂNG NHẬP:</td>
             ...
             <tr>
			  <tr>
           	   <td height="35">XÁC NHẬN MẬT KHẨU:</td>
             ...
             <tr>
               <td height="35"></td>
               <td height="35"><a href="change_pwd.php" class="a1-btn a1-blue">ĐỒNG Ý</a><!--<input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="SUBMIT" >-->
