...
<head>
    ...
    <title>Titan Gym | Xem công việc</title>
				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) 
					{
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
						{
					              ...
					              echo '<td><a href="viewdetailroutine.php?id='.$row['tid'].'"><input type="button" class="a1-btn a1-blue" value="Chi tiết công việc" ></a></td></tr>';
