...
<head>
    ...
    <title>Titan Gym | Thành viên mỗi tháng</title>
...
<form>
	...
	<input type="button" class="a1-btn a1-blue"  style="margin-bottom:5px;" name="search" onclick="showMember();" value="Tìm kiếm">
