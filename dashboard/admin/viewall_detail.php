...
<head>
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<h3>Chỉnh sửa chi tiết thành viên</h3>
		...
		<div class="a1-container a1-dark-gray a1-center">
        	<h6>Chỉnh sửa chi tiết thành viên</h3>
        </div>
         ...
         <tbody><tr>
           <td height="35">
             ...
             <tr>
               ...
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="CHỈNH SỬA">
                 <a href="table_view"><input class="a1-btn a1-blue" id="" value="TRỞ VỀ"></a></td>
             </tr>
