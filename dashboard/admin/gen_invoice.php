...
<table id =space width="760" height="397" border="0" align="center">
  <tr>
    ...
    <td width="317"><p><strong>TITAN GYM</strong></p>
      <p>John,</p>
      <p>Jonghua</p></td>
    <td height="198"><p>Số Sê-ri : <?php echo $row['et_id'] ?></p>
      <p>&nbsp;</p>
      <p>Ngày : <?php echo $row['paid_date']?></p></td>
    </tr>
   
  <tr>
    <td height="118" colspan="3"><p>
Nhận được với lời cảm ơn từ : <?php echo $row['username']?></p>
      <p>
Một khoản tiền Ruby : <?php echo $row['amount']?></p>
      <p>
Trên tài khoản của kế hoạch thành viên: <?php echo $row['planName']?></p></td>
    </tr>
