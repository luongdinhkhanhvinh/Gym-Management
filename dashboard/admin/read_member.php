...
<head>
    ...
    <title>Titan Gym | Lịch sử thành viên</title>
   ...
   <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<table border=1>
			<thead>
				...
				<h3>Lịch sử thanh toán của : - <?php echo $name;?></h3>
						...
						if (mysqli_affected_rows($con) != 0) {
						    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
						      ...
						      if($result2){
						        ...
						        echo '<td><a href="gen_invoice.php?id='.$row['uid'].'&pid='.$row['pid'].'&etid='.$row['et_id'].'"><input type="button" class="a1-btn a1-blue" value="Ghi nhớ" ></a></td></tr>';
						        $memid = 0;
						    }
