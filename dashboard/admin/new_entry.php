...
<head>
    ...
    <title>Titan Gym | Thành viên mới</title>
      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
	    ...
	    <tbody id="plandetls">
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="ĐĂNG KÝ" >
