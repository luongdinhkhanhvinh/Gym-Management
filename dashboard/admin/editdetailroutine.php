...
<head>
    ...
    <title>Titan Gym | Chi tiết thói quen</title>
  ...
  <tr>
  	<td width='186' height='103'>Tên thói quen:</td>
  ...
  <tr>
               <td height="35">&nbsp;</td>
               <td height="35">
			  <input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="Cập nhật">
